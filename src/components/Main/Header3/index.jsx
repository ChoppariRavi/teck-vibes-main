        ...
        <div className="row">
          <div className="col-lg-6 valign">
            <div className="cont">
              ...
              <h1 className="fw-700">Teck Vibes</h1>
              <p>Teck Vibes is a software staffing services firm providing high quality resources meeting the ever-changing demands and requirements of end clients. We build and partner network with clients, implementation partners, primary vendors and introduce top talent to work on some of the leading technologies in the IT industry. </p>
              ...
              <div className="mt-40 flex">
                ...
                <Link href="/about/why-tech-vibes">
                  <a className="btn vid underline">
                    <span className="fw-500 fz-13">Know about us</span>
      ...
      <div className="img half-abs">
        <div className="svg-img">
          <svg x="0px" y="0px" viewBox="0 0 288 288" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="100%" id="blobSvg">
            ...
            <image x="0" y="0" width="100%" height="100%" clipPath="url(#shape)" xlinkHref="img/background/v1.jpg" preserveAspectRatio="none"></image>
          </svg>
        </div>
