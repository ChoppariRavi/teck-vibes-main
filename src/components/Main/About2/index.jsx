        ...
        <div className="row">
          ...
          <div className="col-lg-6 valign">
            <div className="content">
              ...
              <h3 className="mb-20 fz-38 fw-700">Why Teck Vibes</h3>
              <p>Teck Vibes wants to make the hiring process simple. Whether it a client looking for project needs, or it is a primary vendor requiring support to meet his client needs, or it is an experience professional or New College graduate requiring help in finding their next dream job, Teck Vibes is willing to work with each and every one and make this process as simple as possible.</p>
