      ...
      <div className="container">
        <div className="row justify-content-center mb-100">
          ...
          <div className="col-lg-6 valign">
            <div className="text">
              <p>Our team strives hard to provide the high-quality resources to match individual staffing needs with the aim of becoming to be the one stop solution for all the staffing needs in the IT space.</p>
            </div>
          </div>
        </div>
        <div className="row">
