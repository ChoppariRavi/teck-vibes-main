          ...
          <div className="col-lg-6 ">
            <div className="content md-mb50">
              <div className="sub-head radius mb-20">
                <span className="fz-12 ls2 text-u">Join hands with us</span>
              </div>
              <h3 className="mb-20 fz-38 fw-700">Partnership</h3>
              <p>
          ...
          <div className="col-lg-6">
            <div className="content">
              <div className="accordion shadwo">
                <h5 className="mb-40 text-center fw-600">Ways to partnering with us!</h5>
                {
